<div id="contact" class="section">
	<div class="spaced flex-col">
		...
		<div class="mb-3 flex-item-auto">
			<h2 class="subtitle hidden h-4 pl-5">CONTACT</h2>
		</div>
			...
			<div class="flex-row h100" id="contact-flex">
				<div class="col-1">
					<div id="contact-infos" class="flex-col flex-center h100">
						...
						<div id="references" class="mt-2">
							<h3 class="h-5 bg-alizarin padding animate fade-in" id="refenreces-title">References</h3>
							<div class="reference mt-1 animate fade-in">
								<h4 class="h-5">Vincent COUTURIER</h4>
								<div class="pl-1">
			...
			-->
				...
				<div class="col-1">
					<form class="flex-col h100 pl-2" id="contact-form">
						...
						<div align="right">
							<input type="submit" name="send_mail" value="Send"> <!-- need ajax -->
						</div>
					</form>
				</div>
			</div>
